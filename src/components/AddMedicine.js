...
export default function AddMedicine() {
  ...
  const medicinesCollectionRef = collection(db, "food_inventory");
      ...
      <div className="main-panel">
        <div className="content">
          <div className="container-fluid">
            <h4 className="page-title">Create Food</h4>
            <div className="row">
              <div className="col-md-12">
                <div className="card">
                  ...
                  <div className="card-body px-4">
                    ...
                    <div className="form-group">
                      <label htmlFor="power">Food Spicy Level</label>
                      <input
                        type="text"
                        className="form-control"
                    ...
                    <div className="form-group">
                      <label htmlFor="price">Food Price (in ₹.)</label>
                      <input
                        type="text"
                        className="form-control"
